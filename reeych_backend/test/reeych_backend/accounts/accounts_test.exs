defmodule ReeychBackend.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{first_name: "some first_name", id: "7488a646-e31f-11e4-aace-600308960662", job_title: "some job_title", last_name: "some last_name"}
    @update_attrs %{first_name: "some updated first_name", id: "7488a646-e31f-11e4-aace-600308960668", job_title: "some updated job_title", last_name: "some updated last_name"}
    @invalid_attrs %{first_name: nil, id: nil, job_title: nil, last_name: nil}
